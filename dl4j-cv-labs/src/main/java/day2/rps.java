...
public class rps {
    ...
    public static void main(String[] args) throws IOException {
        File inputFile = new ClassPathResource("rockpaperscissors").getFile();
...
//                        .build())
        ...
        MultiLayerNetwork rpsmodel = new MultiLayerNetwork(neuralNetConfiguration);
        rpsmodel.init();

        System.out.println(rpsmodel.summary());
